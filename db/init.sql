...
CREATE TABLE IF NOT EXISTS accounts (
    ...
    account_number VARCHAR(20) UNIQUE NOT NULL DEFAULT LPAD(FLOOR(RANDOM() * 1000000000000000000000000)::TEXT, 50, '0'),
...
-- ----------------------------------------------------------------
-- TRANSACTIONS  (append-only ledger — never update, never delete)
...
CREATE TABLE IF NOT EXISTS transactions (
    ...
    description    TEXT,
    reference_id   UUID DEFAULT uuid_generate_v4(),   -- idempotency key
    created_at     TIMESTAMPTZ DEFAULT NOW()
);

-- ----------------------------------------------------------------
-- INDEXES  (read-path optimisation)
-- ----------------------------------------------------------------
